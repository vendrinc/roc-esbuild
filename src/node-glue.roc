...
makeGlue = \typesByArch ->
    dtsFileContent =
        List.walk typesByArch dtsHeader \buf, types ->
...
#         Unit -> "undefined"
#         Struct { name, fields } ->
#             generateRecord buf types typeId name fields Public

#         Function rocFn ->
#             if rocFn.isToplevel then
#                 buf # We already generated a type for this, so don't do it again!
#             else
#                 generateFunction buf types rocFn

#         _ -> # TODO finish these
#             crash "`roc glue` encountered a type that it doesn't yet know how to translate to a TypeScript type!"

# generateRecord : Str, Types, TypeId, Str, RocStructFields, [Public, Private] -> Str
# generateRecord = \buf, types, id, name, fields, privacy ->
#     ""
