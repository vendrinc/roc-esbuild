...
const buildRocFile = async (rocFilePath: string, addonPath: string, config: { cc: Array<string>; target: string, optimize: boolean }) => {
  ...
  const typedefs =  // TODO don't hardcode this, but rather generate it using `roc glue`
